...
//
//     final pokeModel = pokeModelFromMap(jsonString);

import 'dart:convert';

PokeModel pokeModelFromMap(String str) => PokeModel.fromMap(json.decode(str));

String pokeModelToMap(PokeModel data) => json.encode(data.toMap());
...
class PokeModel {
  ...
  factory PokeModel.fromMap(Map<String, dynamic> json) => PokeModel(
